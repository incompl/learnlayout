...
NOTE: Right now the site is not fully internationalized. Before translation begins, the site must be fully converted to pull all of its text from "en.yaml":https://github.com/incompl/csslayoutsite/blob/master/translations/en.yaml
...
To contribute to a translation, either "email me":mailto:gsmith@incompl.com YAML files, or make pull requests against this repository if you know how.
